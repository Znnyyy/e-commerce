...
import { LayoutDashboard, Package, ShoppingBag, Users, LogOut, MessageSquare } from 'lucide-react';
...
export default function Sidebar() {
  ...
  const links = [
    ...
    { name: 'Reviews', path: '/admin/reviews', icon: MessageSquare, show: isStaff },
